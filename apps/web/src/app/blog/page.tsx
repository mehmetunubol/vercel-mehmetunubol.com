    ...
    <Shell header={<SiteHeader />} footer={<SiteFooter />}>
      <div className="flex flex-col gap-14 pt-6 sm:pt-10">
        <div className="flex flex-col gap-4">
          ...
          <div className="glass flex flex-col gap-1.5 rounded-lg p-4 text-sm text-muted">
            <p>
              <span className="font-medium text-foreground">Heads up:</span>{" "}
              These posts aren&rsquo;t hand-written. They&rsquo;re generated by{" "}
              <span className="font-medium text-foreground">yt-note-agent</span>, a pipeline I
              built that transcribes a YouTube video, summarizes it with AI, and publishes the
              result here — diagrams included when relevant.
            </p>
            <p>Every post links back to its source video for context.</p>
          </div>
        </div>
          ...
          <>
            ...
            {featured ? (
              <Link href={`/blog/${featured.category}/${featured.slug}`} className="group">
                <div className="glass flex flex-col gap-4 rounded-xl p-6 shadow-card transition-shadow duration-300 group-hover:glow-ring sm:p-8">
